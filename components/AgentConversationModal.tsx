  ...
  return (
    <div className='fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 p-4'>
      <div className='neo-panel rounded-2xl max-w-3xl w-full max-h-[90vh] flex flex-col'>
        {/* Header */}
        <div className='flex items-center justify-between p-6 border-b border-slate-800/70 bg-slate-900/60'>
          <div>
            <h2 className='text-2xl font-bold text-white'>Agent Conversation</h2>
        ...
        {conversation.length === 0 && !isRunning && (
          <div className='p-6 border-b space-y-4 bg-slate-900/60'>
        ...
        {/* Human Input Section */}
        {conversation.length > 0 && (
          <div className='p-6 border-t bg-slate-900/70'>
            {!showHumanInput ? (
              <button
        ...
        {/* Controls */}
        <div className='p-6 border-t bg-slate-900/60 flex flex-wrap gap-2 items-center'>
          {isRunning && (
            <>
              <button
                onClick={handlePause}
        ...
        {showSaveDialog && (
          <div className='fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4'>
            <div className='neo-panel rounded-lg max-w-md w-full p-6 space-y-4'>
              <h3 className='text-xl font-bold text-slate-100'>Save Conversation</h3>
